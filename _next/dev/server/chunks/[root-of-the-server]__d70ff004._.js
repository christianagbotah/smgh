...
async function GET(request) {
    try {
        ...
        const items = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].galleryItem.findMany({
...
async function POST(request) {
    ...
    try {
        ...
        const foundationRecordId = formData.get('foundationRecordId');
        ...
        const item = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].galleryItem.create({
            data: {
                title: title || null,
...
async function PUT(request) {
    ...
    try {
        ...
        const item = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].galleryItem.update({
            where: {
                id
            },
            data
...
async function DELETE(request) {
    ...
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].galleryItem.delete({
            where: {
                id
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d70ff004._.js.map