...
"[project]/src/app/api/custom-pages/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    const pages = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].customPage.findMany({
        where: status ? {
            status
        } : undefined,
        orderBy: {
...
async function POST(request) {
    const auth = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireAuth"])();
    ...
    const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].customPage.findUnique({
        where: {
            slug: slug.replace(/^\/+|\/+$/g, '')
        }
    });
    ...
    const page = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].customPage.create({
        data: {
            slug: slug.replace(/^\/+|\/+$/g, ''),
            title,
            content: content || '',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__175b7125._.js.map