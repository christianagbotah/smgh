...
async function GET() {
    try {
        const settings = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].siteSetting.findMany();
        const settingsMap = {};
        settings.forEach((s)=>{
...
async function PUT(request) {
    ...
    try {
        ...
        for (const [key, value] of Object.entries(settings)){
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].siteSetting.upsert({
                where: {
                    key
                },
                update: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__366ef029._.js.map